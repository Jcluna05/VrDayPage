        ...
        switch ( $this->getStickyBarDisplayOn() ) {
            ...
            case 'wc_products_pages':
                if ( function_exists( 'is_product' ) && is_product() ) {
                    ...
                    $can_show = ( $wc_campaign->has_campaign( $this,
                            $page_id ) ) && $wc_campaign->met_conditions( $this, $page_id );
                } else {
                    $can_show = false;
                }
                break;
            case 'specific_pages':
                ...
                break;
            case 'exclude_pages':
                $page_ids = $this->getStickyExcludePages();
                $can_show = !in_array( $page_id, $page_ids );
